          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h4 class="d-flex mx-auto">Login</h4>
              </div>

              <div class="card-body">
                <form method="POST" action="/logon" class="needs-validation" novalidate="">
                  ...
                  <?php if (session()->getFlashdata('message')) : ?>
                    <div class="alert alert-danger" role="alert"> <?= session()->getFlashdata('message'); ?>
                    </div>
                  <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="password" class="form-control" tabindex="2" required>
                    <div class="invalid-feedback">
